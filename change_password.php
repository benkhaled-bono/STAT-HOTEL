	            		...
	            		<div class="col-md-6">
	            			<form method="post" id="user_form">
	            				<div class="form-group">
					          		<div class="row">
						            	<label class="col-md-4 text-left">كلمة المرور الحالية<span class="text-danger">*</span></label>
						            	<div class="col-md-8">
					          	...
					          	<div class="form-group">
					          		<div class="row">
						            	<label class="col-md-4 text-left">كلمة المرور الجديدة <span class="text-danger">*</span></label>
						            	<div class="col-md-8">
					          	...
					          	<div class="form-group">
					          		<div class="row">
						            	<label class="col-md-4 text-left">اعادة ادخال كلمة المرور<span class="text-danger">*</span></label>
						            	<div class="col-md-8">
					          	...
					          	<div class="form-group text-center">
					          		...
					          		<button type="submit" name="submit" id="submit_button" class="btn btn-success"><i class="fas fa-lock"></i> تغيير كلمة المرور</button>
					          	</div>
	            			</form>
	            		</div>
	            		<div class="col-md-3">&nbsp;</div>
