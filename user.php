            ...
            <section class="content">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <h2 class="col-md-10"> 
                            <i class="fas fa-user" style="font-size: larger; color:black;"></i> ادارة المستخدمين</h2>
                            <div class="col text-right">
                                <button type="button" name="add_user" id="add_user" class=" btn btn-primary"><i
                                        class="fas fa-plus"></i> اضافة مستخدم</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <form method="post" id="user_form" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color:#28a745;" >
                                <h4 class="modal-title" id="modal_title">اضافة مستخدم جديد</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div class="form-group text-left ">
                                    <div class="row text-left">
                                        <label class="col-md-6 text-left">اسم المستخدم<span
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-md-6 text-left">كلمة السر<span
                                                class="text-danger text-left">*</span></label>
                                        <div class="col-md-10 text-left">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="type" class="col-md-4 text-left">نوع المستخدم</label>
                                        <div class="col-md-10 text-left">
                                            <select name="admin_type" id="admin_type" class="custom-select" required>
                                                <?php
												if ($arrive->is_master_user()) {
												?>
                                                <option value="Dta" selected>Dta</option>
                                                <?php
												}
												?>
                                                <?php
                                                ...
                                                <option value="Hotel_Agent">Hotel_Agent</option>
                                                <?php
												}
												?>
                                            </select>
